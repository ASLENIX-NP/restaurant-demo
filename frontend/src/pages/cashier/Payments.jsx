  ...
  return (
    <div className="p-6 md:p-8 bg-slate-50 min-h-screen font-sans text-slate-800">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        {[
          { title: "Total Collected", value: "Rs. 0.00", trend: "0% vs yesterday", trendColor: "text-slate-400", icon: <DollarSign size={22} className="text-emerald-600" />, bg: "bg-emerald-100" },
          { title: "Total Payments", value: "0", trend: "0 vs yesterday", trendColor: "text-slate-400", icon: <Receipt size={22} className="text-blue-600" />, bg: "bg-blue-100" },
          { title: "Average Payment", value: "Rs. 0.00", trend: "0% vs yesterday", trendColor: "text-slate-400", icon: <CreditCard size={22} className="text-amber-600" />, bg: "bg-amber-100" },
          { title: "Refunds", value: "Rs. 0.00", trend: "0% vs yesterday", trendColor: "text-slate-400", icon: <Undo2 size={22} className="text-purple-600" />, bg: "bg-purple-100" },
        ].map((stat, index) => (
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col">
          ...
          <div className="p-4 border-t border-slate-100 flex items-center justify-between text-sm text-slate-500 mt-auto">
            <span>Showing {filteredPayments.length > 0 ? 1 : 0} to {filteredPayments.length} of {initialPayments.length} entries</span>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex flex-col">
          ...
          <div className="flex justify-center mb-8 relative">
            ...
            <div className="w-48 h-48 relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-xl font-black text-slate-800">Rs. 0</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 mt-auto">
            {[
              { name: "Cash", amount: "Rs. 0.00", percent: "0%", color: "bg-emerald-500" },
              { name: "Card", amount: "Rs. 0.00", percent: "0%", color: "bg-blue-500" },
              { name: "eSewa", amount: "Rs. 0.00", percent: "0%", color: "bg-green-400" },
              { name: "Khalti", amount: "Rs. 0.00", percent: "0%", color: "bg-purple-500" },
            ].map((method, idx) => (
