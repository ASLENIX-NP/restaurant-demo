...
const UserLog = () => {
  ...
  // Mock Data: In a real app, you would fetch this from your backend (e.g., /api/logs)
  const [logs] = useState([
    { id: "LOG-001", user: "Admin User", role: "Admin", action: "Logged In", device: "Chrome / Windows", ip: "192.168.1.45", status: "Success", time: "10:23 AM", date: "Oct 24, 2023" },
    { id: "LOG-002", user: "Chef Gordon", role: "Chef", action: "Logged In", device: "Safari / Mac", ip: "192.168.1.50", status: "Success", time: "09:15 AM", date: "Oct 24, 2023" },
    { id: "LOG-003", user: "Unknown", role: "Unknown", action: "Failed Login", device: "Firefox / iOS", ip: "45.22.19.102", status: "Failed", time: "08:45 AM", date: "Oct 24, 2023" },
    { id: "LOG-004", user: "Sarah Cashier", role: "Cashier", action: "Logged Out", device: "Chrome / Windows", ip: "192.168.1.12", status: "Success", time: "11:30 PM", date: "Oct 23, 2023" },
    { id: "LOG-005", user: "Admin User", role: "Admin", action: "Password Changed", device: "Chrome / Windows", ip: "192.168.1.45", status: "Success", time: "04:20 PM", date: "Oct 23, 2023" },
    { id: "LOG-006", user: "Waiter John", role: "Waiter", action: "Logged In", device: "App / Android", ip: "192.168.1.33", status: "Success", time: "02:00 PM", date: "Oct 23, 2023" },
  ]);
