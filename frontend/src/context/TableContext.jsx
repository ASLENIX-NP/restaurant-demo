...
export const TableProvider = ({ children }) => {
  const [tables, setTables] = useState([
    ...
    { id: 2, name: 'Table 2', seats: 2, status: 'Available', currentCustomer: 'No Customer' },
    { id: 3, name: 'Table 3', seats: 6, status: 'Available', currentCustomer: 'No Customer' },
    { id: 4, name: 'Table 4', seats: 4, status: 'Available', currentCustomer: 'No Customer' },
    { id: 5, name: 'Table 5', seats: 8, status: 'Available', currentCustomer: 'No Customer' },
